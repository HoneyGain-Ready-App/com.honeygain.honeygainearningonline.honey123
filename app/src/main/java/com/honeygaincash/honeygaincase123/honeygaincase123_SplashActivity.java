...
public class honeygaincase123_SplashActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.honeygaincase123_splash);
    ...
    private void NextScreen() {
        ...
        hndler.postDelayed(new Runnable() {
            @Override
            public void run() {
                honeygaincase123_SplashActivity.this.startActivity(new Intent(honeygaincase123_SplashActivity.this, honeygaincase123_start_page.class));
            }
        }, 8000);
    ...
    void datafromlink() {
        new AsyncTask<Void, Void, String>() {
            ...
            protected String doInBackground(Void... voids) {
                ...
                String dataUrl = "https://adstxt.dev/69a348d434/ads.txt";
